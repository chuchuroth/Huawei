...
another big topic nowadays is how AI revolutionize and transform every industry, in the near future every company will be an AI company and producing tokens, for car company besides manufacturing cars it will also produce the tokens that runs in those cars. and Huawei is a clear **frontrunner** here, I suppose Huawei has already integrated AI models into internal systems and business processes, so The first thing i would do if I'm hired for this position, I will learn about the Huawei's AI strategy and try to be integrated into huawei's Workflow as a cohesive subsystem. I have already adopted lots of AI tools in my daily workflow to help information flow runs faster. Like generative AI and AI agent, for example platforms to create AI agent like agent-kit from openai, or n8n. so basically first define the task execution sequence or the workflow. Next set up API integration so that the agent or assistant can access relevant data. Lastly implement some sort of open source orchestration technology. and I have also attended the udacity program "ai for business", and learned from company pespective, how can new AI tools being developed, deployed, and integrated into various workflows. I can imagine the result in Huawei is probably a fragmented AI ecosystem where tools exist in silos, and abundant user data may reside in on-premise environment, making coordination, interoperability, and governance increasingly complex in different business scenarios. 

Regarding my role of "technology scouting and network building", and "trend analysis and feasibility reality checks", many areas like data processing and information searching are already being outperformed by AI, for instance AI agent can use function calling to connect with external tools like APIs or data sources like LinkedIn and execute data-collection by itself. But I believe people still have some irreplacable unique qualities, like empathy and connect with other people, and creativity and instinct. which I believe is crucial for the “reality checks” in technology planning. So as AI agent is implemented in each step of the workflow, the role i play is "like a supervisor at work", namliy agent orchestration, overseeing how work gets done by AI agent. In the same way, when you combine existing technologies or even different industries, you often end up creating something entirely new. What I mean is, you don’t always need to invent something from scratch to be innovative. Sometimes, it’s about taking your existing skills and applying them in a new context — and that can open the door to a completely new career path or even a new industry. 


so, to sum up, I have dual perspective, I understand both the German way of doing business and the Chinese way. I have substantial Sino-German project experience and a german network, and also technical expertise in mechatronics, and AI skills. I believe I can contribute to tasks like scouting high-potential technologies, conducting feasibility checks, building the right partnerships with European companies, even building innovative and resilient roadmap, and to strengthen Huawei’s position in Europe. and I would like to apply these skills and my engineering expertise in a structured and meaningful way, so to join Huawei is very much the right way, I get to combine my own growth and coincide with the long-term goals of an innovative and well established company.
