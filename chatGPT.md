...
* organise the sentenses in this interview answer to become more logical, cohesive and natural-flowing 
...
another big topic nowadays is how AI revolutionize and transform every industry, in the near future every company will be an AI company and producing tokens, for car company besides manufacturing cars it will also produce the tokens that runs in those cars. and I'm sure Huawei has already adopted AI intensively. so The first thing i would do if I'm hired for this position, I will learn about the Huawei's AI strategy and formulate a cohesive subsystem to be integrated into huawei's Workflow. With new AI tools being developed, deployed, and integrated into various workflows, I can imagine the result in Huawei is probably a fragmented AI ecosystem where tools exist in silos, and abundant user data may reside in on-premise environment, making coordination, interoperability, and governance increasingly complex in different business scenarios. Regarding my role of "technology scouting and network building", and "trend analysis and feasibility reality checks", many areas like data processing and information searching are already being outperformed by AI, for instance AI agent can use function calling to connect with external tools like APIs or data sources like LinkedIn and execute data-collection by itself.  but I believe people still have some irreplacable unique qualities, like empathy and connect with other people, and creativity and instinct. which I believe is crucial for the “reality checks” in technology planning. So as AI agent is implemented in each step of the workflow, the role i play is "like a supervisor at work", namliy agent orchestration, overseeing how work gets done by AI agent. I have attended the udacity program "ai for business", and I have some practical experience in using tools to create AI agent, for example agent-kit from openai, or n8n. so first I'll define the task execution sequence or the workflow. Next, I'll set up API integration so that the agent or assistant can access relevant data. Lastly, I'll implement some sort of open source orchestration technology. 
